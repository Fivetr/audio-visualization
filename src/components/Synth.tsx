...
const Synth = () => {
    ...
    const [envelope] = useState(new Tone.AmplitudeEnvelope({
        attack: 1, 
        decay: 1, 
        sustain: 0.5, 
        release: 1.5
    ...
    oscillator.start();
    const triggerAttack = () => envelope.triggerAttack();   
    ...
    return (
        <>
            <Rack>
                ...
                />
                <OscSimple setWaveform={(newWaveform: Tone.ToneOscillatorType) => oscillator.type = newWaveform}/>
                <EnvelopeASDR 
                    adsr={{
                ...
                />
                <AmpSimple setGain={(newGain: number) => {
                    gain.value = newGain
                    forceUpdate();
                }} gain={gain.value}/>
            </Rack>
